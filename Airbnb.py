...
st.set_page_config(page_title="Airbnb-Data-Analysis", page_icon=":bar_chart:", layout="wide")
...
SELECT = option_menu(
    ...
    styles={"container": {"padding": "0!important", "background-color": "", "size": "cover", "width": "100"},
            ...
            "nav-link": {"font-size": "20px", "text-align": "center", "margin": "-2px", "--hover-color": "#1fb8b8"},
            "nav-link-selected": {"background-color": "#1fb8b8"}})
...
with col1:
        image1 = Image.open("C:\\Users\\Mohan.S\\Desktop\\Mohan_Project\\Project4\\Airbnblogo.jpg")
        st.image(image1, width=300)
        
with col2:
    col2.subheader("Company : Airbnb")
    col2.subheader("Name: Mohan srinivasan")
    col2.subheader("Email: mohandmx01@gmail.com")
    col2.subheader("Batch : DTE1")